 ...
 * lives in the server layer). [stamp] is the client/conformance-side miner.
 */
object Pow {
    const val DAY_MS = 86_400_000L

    /** The spec §12 recommended difficulty for public spools. */
    ...
    /**
     * Mines the smallest counter `n >= startN` whose digest meets [bits], or null once
     * [maxAttempts] counters have been tried. Smallest-first is what the spec §13 vector pins.
     */
    fun stamp(
        scopeId: ByteArray,
        day: Long,
